    ...
    <div style="margin: 40px 0;">
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="border: 1px solid rgba(0,0,0,.1); padding: 10px; margin-top: 10px;direction: ltr;">
                ...
                <div>[posts-slider title="Groupes ethniques" filter_by="ids" limit="4" include="1,2,3,4" style="2" description="The featured articles are selected by experienced editors. It is also based on the reader's rating. These posts have a lot of interest."][/posts-slider]</div>
                ...
                <div>[theme-galleries title="Presentation of ethnic groups" limit="8"][/theme-galleries]</div>
            </div>
            <br>
